...
configure<MixinExtension> {
    ...
    config("dragonlootforge.mixins.json")
}
    ...
    manifest {
        attributes(
            mapOf(
                ...
                "Implementation-Timestamp" to SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ssZ", Locale.ROOT).format(Date()), "MixinConfigs" to "dragonlootforge.mixins.json"
            )
        )
    }
